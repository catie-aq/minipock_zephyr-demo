...
static int hls_lfcd2_pwm_init(const struct device *dev)
{
    ...
    // Print default period and pulse
    LOG_INF("Default period is %d", led->period);

    // Set duty cycle to 50%
    pwm_set_pulse_dt(&cfg->pwm, (uint32_t)((uint64_t)led->period * 0.5));
...
#define HLS_LFCD2_INIT(i)                                                                          \
    static struct hls_lfcd2_data hls_lfcd2_data_##i;                                               \
                                                                                                   \
    static const struct hls_lfcd2_config hls_lfcd2_config_##i = {                                  \
